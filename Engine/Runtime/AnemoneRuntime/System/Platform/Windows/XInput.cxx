...
namespace Anemone::Internal::Windows
{
    ...
    float XInputImpl::ApplyLinearDeadzone(float value, float max, float deadzone)
    {
        if (value < -deadzone)
        {
            value += deadzone;
    ...
    void XInputImpl::HandleGamepadButton(GamepadState& state, GamepadButton button) const
    {
