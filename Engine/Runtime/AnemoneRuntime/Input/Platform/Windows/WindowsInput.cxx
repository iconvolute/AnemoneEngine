...
namespace Anemone
{
    ...
    void WindowsInput::NotifyWindowActivated(Window& window)
    {
        (void)window;
        this->_keyModifiers = CaptureModifiers();
    }

    void WindowsInput::NotifyWindowDeactivated(Window& window)
    {
        (void)window;
        this->_keyModifiers = CaptureModifiers();
    ...
    void WindowsInput::NotifyApplicationActivated()
    {
        this->_keyModifiers = CaptureModifiers();
    }

    void WindowsInput::NotifyApplicationDeactivated()
    {
        this->_keyModifiers = CaptureModifiers();
    ...
    bool WindowsInput::StartTracking(HWND handle)
    {
    ...
    MouseButtons WindowsInput::ConvertToMouseButtons(UINT keyState)
    {
        MouseButtons result{};
