...
{
    ManualResetEventSlim::ManualResetEventSlim(bool signaled)
        : m_Inner{signaled ? StateSignaled : StateReset}
    {
    }

    bool ManualResetEventSlim::Reset()
    {
    ...
    void ManualResetEventSlim::Set()
    {
        ...
        FutexWakeAll(this->m_Inner);
    }

    bool ManualResetEventSlim::IsSignaled() const
    {
