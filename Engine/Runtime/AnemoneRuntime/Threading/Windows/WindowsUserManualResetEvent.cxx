...
namespace Anemone
{
    WindowsUserManualResetEvent::WindowsUserManualResetEvent(bool signaled)
        : m_Inner{signaled ? StateSignaled : StateReset}
    {
    }

    bool WindowsUserManualResetEvent::Reset()
    {
        return !!this->m_Inner.exchange(StateReset);
    }

    void WindowsUserManualResetEvent::Set()
    {
    ...
    bool WindowsUserManualResetEvent::IsSignaled() const
    {
        return !!this->m_Inner.load(std::memory_order::acquire);
    }

    void WindowsUserManualResetEvent::Wait()
    {
