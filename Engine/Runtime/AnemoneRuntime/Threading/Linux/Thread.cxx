...
namespace Anemone::Threading
{
    ...
    {
        Private::NativeThread& nativeThis = Platform::Create(this->_native);
    ...
    Thread& Thread::operator=(Thread&& other) noexcept
    {
        if (this != &other)
        {
            ...
            Private::NativeThread& nativeThis = Platform::Get(this->_native);
            Private::NativeThread& nativeOther = Platform::Get(other._native);
    ...
    {
        Private::NativeThread const& nativeThis = Platform::Get(this->_native);
