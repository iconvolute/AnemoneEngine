...
namespace Anemone::Graphics
{
    ...
    ANEMONE_RUNTIME_GRAPHICS_API size_t GetBlockSize(PixelFormat format);
    ANEMONE_RUNTIME_GRAPHICS_API size_t GetPixelBits(PixelFormat format);
    ANEMONE_RUNTIME_GRAPHICS_API size_t GetColorBits(PixelFormat format);
    ANEMONE_RUNTIME_GRAPHICS_API size_t GetAlphaBits(PixelFormat format);
    ANEMONE_RUNTIME_GRAPHICS_API bool IsCompressed(PixelFormat format);
    ANEMONE_RUNTIME_GRAPHICS_API size_t GetDepthBits(PixelFormat format);
    ANEMONE_RUNTIME_GRAPHICS_API size_t GetStencilBits(PixelFormat format);
    ANEMONE_RUNTIME_GRAPHICS_API size_t GetChannelsCount(PixelFormat format);
