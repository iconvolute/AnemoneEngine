...
namespace Anemone::Graphics
{
    ...
    class ANEMONE_RUNTIME_GRAPHICS_API Image final : public ReferenceCounted<Image>
    {
    private:
        ImageSize _size;
        size_t _mipCount;
...
namespace Anemone::Graphics
{
    ANEMONE_RUNTIME_GRAPHICS_API std::expected<Reference<Image>, Error> ImageDecoder_DDS(std::span<std::byte> buffer);
    ANEMONE_RUNTIME_GRAPHICS_API std::expected<void, Error> ImageEncoder_DDS(BinaryWriter& writer, Image const& image);
}
