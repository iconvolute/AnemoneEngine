#include "AnemoneRuntime.HostApplication/Platform/Windows/WindowsXInput.hxx"
...
namespace Anemone
{
    ...
    namespace
    {
        UninitializedObject<WindowsXInput> gWindowsXInput;
    }

    void WindowsXInput::Initialize()
    {
        gWindowsXInput.Create();
    }

    void WindowsXInput::Finalize()
    {
        gWindowsXInput.Destroy();
    }

    WindowsXInput& WindowsXInput::Get()
    {
        return *gWindowsXInput;
    }

    void WindowsXInput::Poll(HostApplicationEvents& events)
    {
        XINPUT_STATE state;
    ...
    void WindowsXInput::HandleGamepadButton(HostApplicationEvents& events, GamepadState& state, GamepadButton button) const
    {
