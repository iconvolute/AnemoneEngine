...
namespace Anemone
{
    ...
    public:
        ...
        ANEMONE_RUNTIME_BASE_API static void ReportErrorWin32(DWORD error, std::source_location const& location);

        ANEMONE_RUNTIME_BASE_API static void ReportErrorHRESULT(HRESULT hresult, std::source_location const& location);

        ANEMONE_RUNTIME_BASE_API static Error TranslateErrorCodeHRESULT(HRESULT hr);

        ANEMONE_RUNTIME_BASE_API static Error TranslateErrorCodeWin32(DWORD error);
