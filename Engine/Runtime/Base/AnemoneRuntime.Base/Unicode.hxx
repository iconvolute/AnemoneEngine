...
namespace Anemone::Unicode
{
    ANEMONE_RUNTIME_BASE_API bool IsValidCodePoint(char32_t value);

    ANEMONE_RUNTIME_BASE_API char32_t SanitizeCodepoint(char32_t value);
}

namespace Anemone::Unicode
{
    ANEMONE_RUNTIME_BASE_API ConversionResult Decode(char32_t& result, const uint8_t*& first, const uint8_t* last);
    ...
    ANEMONE_RUNTIME_BASE_API ConversionResult Encode(uint8_t*& first, uint8_t* last, char32_t codepoint);
    ...
    ANEMONE_RUNTIME_BASE_API ConversionResult Decode(char32_t& result, const char16_t*& first, const char16_t* last);

    ANEMONE_RUNTIME_BASE_API ConversionResult Encode(char16_t*& first, char16_t* last, char32_t codepoint);

    ANEMONE_RUNTIME_BASE_API ConversionResult Decode(char32_t& result, const char32_t*& first, const char32_t* last);

    ANEMONE_RUNTIME_BASE_API ConversionResult Encode(char32_t*& first, char32_t* last, char32_t codepoint);
}

namespace Anemone::Unicode
{
    ANEMONE_RUNTIME_BASE_API ConversionResult Convert(
...
namespace Anemone::Unicode
{
    ANEMONE_RUNTIME_BASE_API bool Validate(
