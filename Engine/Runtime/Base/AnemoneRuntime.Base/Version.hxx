...
namespace Anemone
{
    ...
    [[nodiscard]] ANEMONE_RUNTIME_BASE_API std::to_chars_result ToChars(char* first, char* last, Version const& version);
    [[nodiscard]] ANEMONE_RUNTIME_BASE_API std::from_chars_result FromChars(char const* first, char const* last, Version& version);
}
