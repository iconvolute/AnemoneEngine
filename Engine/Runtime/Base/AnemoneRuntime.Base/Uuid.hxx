...
namespace Anemone
{
    ...
    {
        ANEMONE_RUNTIME_BASE_API static Uuid CreateRandom(Random& generator);

        ANEMONE_RUNTIME_BASE_API static Uuid CreateSortable(Random& generator);

        ANEMONE_RUNTIME_BASE_API static Uuid CreateSortable(Random& generator, DateTime dateTime);

        ANEMONE_RUNTIME_BASE_API static Uuid CreateNamed(std::string_view name, uint64_t seed = 0);

        ANEMONE_RUNTIME_BASE_API static Uuid CreateNamed(Uuid const& base, std::string_view name, uint64_t seed = 0);
    };
