...
namespace Anemone
{
    ...
    [[nodiscard]] ANEMONE_RUNTIME_BASE_API bool ToString(std::string& result, DurationMembers const& value, std::string_view format);
    ...
    public:
        ...
        [[nodiscard]] ANEMONE_RUNTIME_BASE_API static Duration New(int64_t seconds, int64_t nanoseconds);

        [[nodiscard]] ANEMONE_RUNTIME_BASE_API static std::optional<Duration> FromMembers(DurationMembers const& members);

        [[nodiscard]] ANEMONE_RUNTIME_BASE_API DurationMembers ToMembers() const;
    };
