...
namespace Anemone
{
    struct DateTime final
    {
        ...
        [[nodiscard]] ANEMONE_RUNTIME_BASE_API static DateTime Now();
        [[nodiscard]] ANEMONE_RUNTIME_BASE_API static DateTime UtcNow();

        [[nodiscard]] ANEMONE_RUNTIME_BASE_API static std::optional<DateTime> FromMembers(DateTimeMembers const& members);
        [[nodiscard]] ANEMONE_RUNTIME_BASE_API DateTimeMembers ToMembers() const;
    };
    ...
    [[nodiscard]] ANEMONE_RUNTIME_BASE_API bool ToString(std::string& result, DateTimeMembers const& value, std::string_view format);
...
namespace Anemone
{
    struct DateTimeOffset final
    {
        ...
        [[nodiscard]] ANEMONE_RUNTIME_BASE_API static DateTimeOffset Now();
        [[nodiscard]] ANEMONE_RUNTIME_BASE_API static Duration GetCurrentTimeZoneBias();
    };
}
