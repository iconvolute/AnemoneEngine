...
#include "AnemoneRuntime.RenderVulkan/VulkanSwapChain.hxx"
#include "AnemoneRuntime.RenderVulkan/VulkanQueue.hxx"
#include "AnemoneRuntime.RenderVulkan/VulkanUtils.hxx"
#include "AnemoneRuntime.RenderVulkan/VulkanBuffer.hxx"
...
namespace Anemone
{
    ...
    {
        this->m_physicalDevice = this->SelectPhysicalDevice(GpuVendor::Unknown);
        ...
        if (this->m_instanceExtensions.KHR_get_surface_capabilities2)
        {
        ...
        this->m_physicalDeviceExtensions.EXT_device_address_binding_report = this->m_instanceExtensions.EXT_debug_utils && hasExtension(VK_EXT_DEVICE_ADDRESS_BINDING_REPORT_EXTENSION_NAME, UINT32_MAX);
        ...
        if (this->m_instanceExtensions.KHR_surface_maintenance1)
        {
    ...
    VkResult VulkanDevice::QueryInstanceLayerProperties(
        std::vector<VkLayerProperties>& outLayerProperties)
    {
        VkResult result;
        uint32_t count = 0;
    ...
    VkResult VulkanDevice::QueryInstanceExtensionProperties(
        std::vector<VkExtensionProperties>& outExtensionProperties,
        const char* layerName)
    {
        VkResult result;
    ...
    VkResult VulkanDevice::QueryPhysicalDevices(
        VkInstance instance,
    ...
    VkPhysicalDevice VulkanDevice::SelectPhysicalDevice(GpuVendor preferredVendor) const
    {
    ...
    VKAPI_ATTR VkBool32 VKAPI_CALL VulkanDevice::DebugReportCallback(
...
namespace Anemone
{
    Reference<GpuDevice> CreateGpuDevice()
    {
