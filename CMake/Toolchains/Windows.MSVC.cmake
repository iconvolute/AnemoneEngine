...
set(TOOLCHAIN_MSVC_PATH "C:/Program Files/Microsoft Visual Studio/18/Community/VC/Tools/MSVC/${TOOLCHAIN_MSVC_VERSION}/bin/Host${CMAKE_VS_PLATFORM_TOOLSET_HOST_ARCHITECTURE}/${CMAKE_CXX_COMPILER_ARCHITECTURE_ID}/")
...
if (CMAKE_CXX_COMPILER_ARCHITECTURE_ID STREQUAL "arm64")
    set(TOOLCHAIN_COMMON_COMPILER_FLAGS "${TOOLCHAIN_COMMON_COMPILER_FLAGS} -arch:armv8.1 -Zc:arm64-aliased-neon-types- -D_ARM64_DISTINCT_NEON_TYPES")
endif()

if (CMAKE_CXX_COMPILER_ARCHITECTURE_ID STREQUAL "x64")
    set(TOOLCHAIN_COMMON_COMPILER_FLAGS "${TOOLCHAIN_COMMON_COMPILER_FLAGS} -arch:AVX2 -favor:AMD64 -fpcvt:IA -jumptablerdata -D__AVX__=1")
endif()
